...
const AllProducts = () => {
    return (
        <div className="relative max-w-sm mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
            {/* <!-- Image (Absolute) --> */}
            <img src={imagePro} alt="Decorative Image" className="w-20 h-20 rounded-full border-4 border-white shadow-md absolute top-0 end-0 transform translate-x-3 -translate-y-3" />
